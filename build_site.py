...
FOOTER=f'''<footer><div class="in">
 ...
 <div style="border-top:1px solid {INKH};padding-top:22px;font-size:14px;color:{INKS}">
  <a href="mailto:build@opendiabetic.com">build@opendiabetic.com</a><span class="sepdot">·</span><a href="https://x.com/opendiabetics" target="_blank" rel="noopener">{XGLYPH} @opendiabetics</a><span class="sepdot">·</span>Jupiter, Florida</div>
